...
    const delayInSeconds = 60 * 60; // 1800 saniye
...
      Alert.alert(
        "Hatırlatma Kuruldu",
        `Verilerinizi kontrol etmeniz için bir hatırlatma bildirimi alacaksınız.`,
        [{ text: "Tamam" }]
      );
    } catch (e) {
...
haline getirir.</Text>
          ...
          <View style={styles.stepCard}>
            ...
            <Text style={styles.stepDescription}>Dosyanız birkaç dakika ile bir saat arasında hazırlanır. Verileriniz hazır olduğunda size bir bilgilendirme e-postası gönderilir.</Text>
            <Text style={styles.stepDescription}>Dosyanızın durumunu öğrenmek için gelen kutunuzu kontrol edebilir veya veri yükleme sayfasına bakabilirsiniz.</Text>
            <Text style={styles.stepDescription}>Kontrol etmenizi hatırlatmak için bildirim alabilirsiniz.</Text>
    ...
    if (activeInfo === 1) {
      title = "Veri Talep Etme";
       steps = [
            ...
            { text: "4. 'Bilgileri özelleştir' seçeneğine tıklayın ve sadece 'bağlantılar' kısmını işaretleyin. Diğer seçenekler işaretlenmişse kaldırın."},
...
const styles = StyleSheet.create({
  container: {
    ...
    paddingTop: Platform.OS === 'ios' ? 30 : 0, //eski değer 50
  },
  content: {
    padding: 20,
    alignItems: "center",
