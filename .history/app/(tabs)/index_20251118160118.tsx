...
const scheduleReminder = async () => {
  console.log("Bildirim fonksiyonu çağrıldı");
  await Notifications.scheduleNotificationAsync({
    
    content: {
      title: "Followly Hatirlatma",
      body: "📩 Gelen kutunuzu kontrol edin. Instagram verileriniz hazir olabilir.",
    },
    trigger: { seconds: 60 } as any // 1 dakika sonra
  });
  console.log("Bildirim planlandı. ");
  Alert.alert("Hatırlatma Ayarlandı", "1 dakika sonra bildirim alacaksınız.");
};
      ...
      <ScrollView style={styles.pageContent}> 
        <View style={styles.container}>
          ...
          <View style={styles.stepCard}>
            ...
            <View style={styles.buttonWrapper}>
            <Button title="Hatırlat" onPress={scheduleReminder} color="#0927eb" />
            </View>
          </View>
