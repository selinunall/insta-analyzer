...
const ACCOUNTS_CENTER_DATA_URL = "https://accountscenter.instagram.com/info_and_permissions/dyi/?entry_point=notification"; 
      ...
      case 'DOWNLOAD_WEBVIEW':
        return (
          <View style={styles.webviewContainer}>
            {/* webviewHeader'ı zIndex ile en üste alıyoruz */}
...
const styles = StyleSheet.create({
  ...
  webviewHeader: {
    ...
    borderBottomWidth: 1,
    borderColor: '#ddd',
    // KRİTİK: Z-index ile Webview'ın üzerine çıkmasını sağla
    zIndex: 10, 
