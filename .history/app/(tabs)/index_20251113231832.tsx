          ...
          <View style={styles.stepsContainer}>
            <View style={styles.stepCard}>
              ...
              <Text style={styles.stepNumber}>1. Adım</Text>
               <Text style={styles.stepDescription}>Instagram’dan veri talebinde bulunun. aaaaaaaaaaaaaa</Text>
...
const styles = StyleSheet.create({
 ...
 // Yeni sonuç kartı stilleri
  ...
  stepsContainer: {
  flexDirection: 'row',       // kartları yatay hizalar
...
stepCard: {
  width: '32%',               // 3 kartın yan yana sığması için %30 genişlik
  backgroundColor: '#fff',
  borderWidth: 1,
  borderColor: '#ccc',
  borderRadius: 10,
