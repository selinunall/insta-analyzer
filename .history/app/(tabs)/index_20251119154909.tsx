    ...
    switch (appState) {
      ...
      const homeMetrics = analysisResults ? analysisResults.all_metrics : {
                ...
                const analysisData = [
                  ...
                  { title: "Karşılıklı Takip", key: 'mutual_following_count' },
                  { title: "Sizi Geri Takip Etmeyenler ", key: 'not_following_back_count' },
                  { title: "Sizin Geri Takip Etmedikleriniz", key: 'you_not_following_count' },
                  { title: "Son Zamanlarda Takibi Bıraktıklarınız", key: 'unfollowed_count' },
                  { title: "Yeni Takipçileriniz ", key: 'recent_followers_count' },

                  { title: "Gönderdiğiniz ve Kabul Edilen Takip İstekleri", key: 'accepted_requests_count' },
                  { title: "Gönderdiğiniz ve Bekleyen Takip İstekleri", key: 'pending_requests_count' },

                  { title: "Engellenedikleriniz", key: 'blocked_count' },
                  { title: "Hikayenizi Gizledikleriniz", key: 'hide_story_count' },
                  { title: "Kısıtladıklarınız", key: 'restricted_profiles_count' },
                ];
        return (
...
haline getirir.</Text>
  ...
  const renderAnalysisInfoModal = () => {
    ...
    const analysisData = [
        ...
        { title: "Sizi Geri Takip Etmeyenler", key: 'not_following_back_count' },
        { title: "Sizin Geri Takip Etmedikleriniz", key: 'you_not_following_count' },
        { title: "Son Takibi Bıraktıklarınız", key: 'unfollowed_count' },
        { title: "Yeni Takipçileriniz ", key: 'recent_followers_count' },
        { title: "Gönderdiğiniz ve Kabul Edilen Takip İstekleri", key: 'accepted_requests_count' },
        { title: "Gönderdiğiniz ve Bekleyen Takip İstekleri", key: 'pending_requests_count' },
