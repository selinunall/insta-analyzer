...
haline getirir.</Text>
          ...
          <View style={styles.stepCard}>
            ...
            <Text style={styles.stepDescription}>Dosyanızın hazır olup olmadığını öğrenmek için gelen kutunuzu kontrol edebilir veya veri yükleme sayfasına tıklayıp görebilirsiniz. Dilerseniz Kontrol etmenizi hatırlatmak için bildirim gönderebiliriz.</Text>
