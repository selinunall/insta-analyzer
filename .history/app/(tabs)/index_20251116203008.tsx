    ...
    switch (appState) {
      ...
      <ScrollView style={styles.pageContent}>
        ...
        <View style={styles.analysisContainer}>
            <AnalysisCard title="Takipçiler" value="351" />
            <AnalysisCard title="Takip Edilenler" value="811" />
            <AnalysisCard title="Takibi Bıraktıklarım" value="36" />
            <AnalysisCard title="Geri Takip Etmeyenler" value="36" />
            <AnalysisCard title="Geri Takip Etmediklerim" value="36" />
            <AnalysisCard title="En Çok Etkileşim Kurdukların" value="3" />
            <AnalysisCard title="En Az Etkileşim Kurdukların" value="12" />
            <AnalysisCard title="Hikayeyi İzlemeyenler" value="300" />
            <AnalysisCard title="Seni Engelleyenler (Tahmini)" value="1" />
            <AnalysisCard title="Gizli Hayranlar" value="7" />
          </View>
