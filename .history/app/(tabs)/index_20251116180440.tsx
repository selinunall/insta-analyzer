...
export default function App() {
  ...
  const renderContent = () => {
    ...
    if (activeInfo === 1) {
      ...
      text = "4. 'Bilgileri özelleştir' sçeneğine tıklayın, sadece 'bağlantılar' kısmındaki kutucukları işaretleyin ve diğer kutucukların işaretlemelerini kaldırın. 'Kaydet' tuşuna basın";
      text = "5. 'Tarih aralığı seçimi için 'her zaman' seçeneğini seçin.";
      text = "6. Format seçeneği için “JSON” seçeneğine tıklayın ve kaydedin.";
      text = "7. “Dışa aktarımı başlat” butonuna tıklayın.";
    
    }
    else if (activeInfo === 2) {
      title = "E-mail Bildirimi";
      text = "Instagram, veri talebi aldıktan sonra genellikle en geç 1 saat içerisinde verileri hazırlar. ";
      text = "Veriler hazırlanınca hesabının bağlı olduğu mail adresine bir bilgilendirme maili gönderilir. Bilgilendirme mailini alıp almadığınızı görmek için e-mail hesabınızın gelen kutusunu kontrol edebilirsiniz.";
      text = "İlgili maili aldıktan sonra verileri yükleme aşamasına geçebilirsiniz.";
      text = "Ayrıca mailinizi kontrol etmeniz için size hatırlatma bildirimi göndereceğiz.";
    }
    else if (activeInfo === 3) {
      title = "Verileri İndirme";
      text = "1. Hazırlanmış olan verileri yüklemek için “Download” butonuna tıklayın.";
