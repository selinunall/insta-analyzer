      ...
      return (
        <View style={styles.webviewContainer}>
          ...
          <View style={styles.webviewHeader}>
            <View style={styles.webviewInfoArea}>
                <Text style={styles.webviewInfoText}>Bilgi için tıklayın.</Text> 
                <TouchableOpacity 
...
const styles = StyleSheet.create({
  ...
  webviewInfoArea: { 
        position: 'absolute', 
        left: 10, // Sol taraftan boşluk
        top: Platform.OS === 'ios' ? 40 : 15, // Dikey hizalama (Başlığın hemen üstüne denk gelmesi için)
        flexDirection: 'row',
        alignItems: 'center',
        zIndex: 11,
        padding: 5,
