...
haline getirir.</Text>
          ...
          <View style={styles.stepCard}>
            ...
            <Text style={styles.stepDescription}>Veri talebiniz oluşturulduktan sonra Instagram, birkaç dakika ile bir saat arasında verilerinizi hazırlar.</Text>
            <Text style={styles.stepDescription}>Verileriniz hazır olduğunda size bir bilgilendirme e-postası gönderilir.</Text>
            <Text style={styles.stepDescription}>Bu nedenle e-posta kutunuzu düzenli olarak kontrol etmenizi öneririz.</Text>
            <View style={styles.buttonWrapper}>
