...
haline getirir.</Text>
          ...
          <View style={styles.stepCard}>
            ...
            <Text style={styles.stepDescription}>Instagram, birkaç dakika ile bir saat arasında verilerinizi hazırlar. Verileriniz hazır olduğunda size bir bilgilendirme e-postası gönderilir.</Text>
            <Text style={styles.stepDescription}>Dosyanızın hazır olup olmadığını öğrenmek için gelen kutunuzu kontrol edebilir veya veri yükleme sayfasına tıklayıp görebilirsiniz. Dilerseniz Kontrolleri sağlamanızı hatırlatmak için bildirim gönderebiliriz.</Text>
