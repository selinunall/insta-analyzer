...
haline getirir.</Text>
          ...
          <View style={styles.stepCard}>
            ...
            <Text style={styles.stepDescription}>Dosyanızın durumunu öğrenmek için gelen kutunuzu kontrol edebilir veya veri yükleme sayfasından görebilirsiniz. Dilerseniz Kontrol etmenizi hatırlatmak için bildirim gönderebiliriz.</Text>
