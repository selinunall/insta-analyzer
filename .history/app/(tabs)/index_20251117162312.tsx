        ...
        <View style={styles.analysisListContainer}>
          {Array.from({ length: 10 }).map((_, index) => (
            <View key={index} style={styles.analysisCard}>
              <Text style={styles.analysisTitle}>{index + 1}. Takip Analizi Örneği</Text>
              <Text style={styles.analysisValue}>555</Text>
            </View>
         ))}
          </View>
        </View>
                        ...
                        <ScrollView style={styles.container}>
                            <View style={styles.content}>
                                ...
                                <View style={styles.resultsCard}>
                                    ...
                                    <Text style={styles.resultItemTitle}>7. Gönderdiğiniz Takip İstekleri:</Text>
                                    <Text style={styles.resultItemValue}>{metrics.send_requests_count}</Text>

                                    <View style={styles.separator} />

                                    {/* 8. Bekleyen Takip İstekleri */}
                                    <Text style={styles.resultItemTitle}>8. Bekleyen Takip İstekleri:</Text>
