...
export default function App() {
  ...
  const renderContent = () => {
    ...
    if (activeInfo === 1) {
      title = "1. Adım: Veri Talep Etme";
      text = "Instagram’ın resmi sayfasından veri talebi oluşturmanız gerekiyor. Bu işlem genelde 1 dakika sürer.";
    }
    else if (activeInfo === 2) {
      title = "2. Adım: E-mail Bildirimi";
      text = "nstagram, veri talebi aldıktan sonra genellikle en geç 1 saat içerisinde verileri hazırlar. Veriler hazırlanınca hesabının bağlı olduğu mail adresine bir bilgilendirme maili gönderilir. İlgili maili aldıktan sonra verileri yükleme aşamasına geçebilirsiniz. E-mail gelen kutunuzu kontrol etmeniz için size hatırlatma bildirimi göndereceğiz.";
    }
    else if (activeInfo === 3) {
      title = "3. Adım: Verileri İndirme";
      text = "E-mail içindeki bağlantıya tıklayarak verilerinizi indirebilirsiniz.";
    }
