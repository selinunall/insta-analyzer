...
haline getirir.</Text>
          ...
          <View style={styles.stepCard}>
            ...
            <Text style={styles.stepDescription}>Verileriniz birkaç dakika ile bir saat arasında hazırlanır. Verileriniz hazır olduğunda size bir bilgilendirme e-postası gönderilir.</Text>
            <Text style={styles.stepDescription}>Dosyanızın durumunu öğrenmek için gelen kutunuzu kontrol edebilir veya veri yükleme sayfasından görebilirsiniz.</Text>
