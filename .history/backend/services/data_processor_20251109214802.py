...
class DataProcessor:
    ...
    def run_analysis(self) -> dict:
        ...
        self.analysis_results = {
            "totalPosts": total_followers, 
            "averageLikes": total_following, 
            "mostLikedPost": f"GT Yapmayan Sayısı: {unfollowers_count}", 
            "topFollowerCountry": f"İlk GT Yapmayan: {top_unfollower}" 
        }
