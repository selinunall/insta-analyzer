...
class DataProcessor:
    ...
    def run_analysis(self) -> dict:
        ...
        followers_data = self._load_json_data('connections/followers_and_following/followers_1.json')
        following_data = self._load_json_data('connections/followers_and_following/following.json')
