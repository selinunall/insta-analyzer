...
class DataProcessor:
    ...
    def run_analysis(self) -> dict:
        """
        Tüm takipçi/takip dosyaları üzerinde derinlemesine analiz yapar ve 7 metrik döndürür.
        """
        ...
        data = {
            ...
            'received_requests': self._load_json_data(FILE_PATH_PREFIX + 'following_requests_you\'ve_received.json'),
        ...
        self.analysis_results = {
            # SADECE all_metrics anahtarını gönderiyoruz.
            "all_metrics": analysis_metrics
            # Eski "TakipçiSayısı" vb. alanlar KALDIRILDI
        }
