...
class DataProcessor:
    ...
    def run_analysis(self) -> dict:
        ...
        self.analysis_results = {
            "totalPosts": total_followers, # Toplam Takipçi Sayısı
            "averageLikes": total_following, # Toplam Takip Edilen Sayısı
            "mostLikedPost": f"GT Yapmayan Sayısı: {unfollowers_count}", # Unfollower Sayısı/Mesajı
            "topFollowerCountry": f"İlk GT Yapmayan: {top_unfollower}" # İlk Unfollower
        }
